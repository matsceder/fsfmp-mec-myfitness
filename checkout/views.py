...
def cache_checkout_data(request):
    try:
        ...
        messages.error(request, "Something went wrong. We can't process \
            your payment at the moment. Please try again later.")
...
def checkout(request):
    ...
    if request.method == 'POST':
        ...
        if order_form.is_valid():
            ...
            for item_id, quantity in cart.items():
                try:
                    ...
                    messages.error(request, (
                        "One of the products wasn't recognized in our database. \
                        Please call us for assistance with this order.")
                    )
                    order.delete()
            ...
            messages.error(request, "There was an error handling your form. \
